...
public class InputHandler {
    ...
    private static final String  DEBUG_FILE = "C:\\Users\\jarob\\Documents\\Java\\Claude\\SpringBootWarehouseCLI\\data\\test_input.txt";
    ...
    private static String nextDebugLine() {
        try {
            ...
            // End of file — fall back to console so the app doesn't crash
